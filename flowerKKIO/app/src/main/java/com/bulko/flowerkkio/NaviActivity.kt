...
import com.bulko.flowerkkio.HomeFragment
...
private const val TAG_HOME = "calender_fragment"
private const val TAG_SUBSCRIBE = "home_fragment"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.navigationView.setOnItemSelectedListener { item ->
            when(item.itemId) {
                ...
                R.id.SubRecFragment -> setFragment(TAG_SUBSCRIBE, SubRecFragment())
